...
(function () {
  ...
  style.textContent = `
    ...
    #ai-fab:hover { transform: scale(1.1); box-shadow: 0 6px 28px rgba(14,165,233,0.55); }
    #ai-fab .fab-badge {
    ...
    #ai-panel {
      ...
      width: 400px; max-height: 600px; border-radius: 16px;
      ...
      <div class="ai-header">
        <div class="ai-header-left">
          ...
          <div>
            ...
            <div class="ai-subtitle">CloudControl 智能助手</div>
          </div>
        </div>
